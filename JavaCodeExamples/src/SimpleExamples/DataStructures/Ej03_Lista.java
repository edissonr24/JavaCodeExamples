 ...
 * @author xavier
 */
public class Ej03_Lista {
    // Puntero que indica el inicio de la lista o conocida tambien
    // como cabeza de la lista.
    private Ej03_Nodo inicio;
    // Variable para registrar el tamaño de la lista.
    private int tamanio;
    /**
     * Constructor por defecto.
     */
    public void Ej03_Lista(){
        inicio = null;
        tamanio = 0;
    }
    /**
    ...
    public void insertarPorReferencia(int referencia, int valor){
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                Ej03_Nodo siguiente = aux.getSiguiente();
    ...
    public void removerPorReferencia(int referencia){
        ...
        if (buscar(referencia)) {
            ...
            if (inicio.getValor() == referencia) {
                ...
                Ej03_Nodo siguiente = aux.getSiguiente().getSiguiente();
