// Fig. 20.4: ExcepcionListaVacia.java
...
public class ExcepcionListaVacia extends RuntimeException {
   ...
   {
      this( "Lista" );   // llamar al otro constructor de ExcepcionListaVacia
   }

   // constructor
   public ExcepcionListaVacia( String nombre )
   {
      super( nombre + " esta vacia" );  // llamar al constructor de la superclase
   }
