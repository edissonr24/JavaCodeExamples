...
public class PruebaInterfaz {
   ...
   {
      // establecer formato de número de punto flotante
      ...
      Figura arregloDeFiguras[] = new Figura[ 3 ];  // crear arreglo tipo Figura
      ...
      // de cadena, área y volumen para todos los objetos Figura en el arreglo
